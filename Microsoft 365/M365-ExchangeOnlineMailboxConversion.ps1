...
$ListMbox = Get-Mailbox $_.DistinguishedName | Select-Object Identity,PrimarySmtpAddress,RecipientTypeDetails | Out-Gridview
$ListMbox | ForEach-Object {Set-Mailbox -Identity $_.DistinguishedName -Type $TypeDest}
...
$ListMailbox | Out-Gridview -PassThru | ForEach-Object {Set-Mailbox -Identity $_.DistinguishedName -Type $TypeDest}
