...
ForEach ($dg in $ListDG) {$ListUsers | ForEach-Object {Add-DistributionGroupMember -Identity $dg.DistinguishedName -Member $_.DistinguishedName -ErrorAction SilentlyContinue;}}
